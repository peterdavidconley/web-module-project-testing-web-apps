...
* [x] the header h1 element exists. Include three asserts, if the header is in the document, if the heads is truxhy, if the header has the correct test content.
